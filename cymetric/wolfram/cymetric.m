...
NotebookDataLength[    156848,       3298]
NotebookOptionsPosition[    155890,       3269]
NotebookOutlinePosition[    156342,       3286]
CellTagsIndexPosition[    156299,       3283]
WindowFrame->Normal*)

(* Beginning of Notebook Content *)
Notebook[{
Cell[BoxData[
 RowBox[{"BeginPackage", "[", "\"\<cymetric`\>\"", "]"}]], "Input",
 InitializationCell->True,
 CellChangeTimes->{{3.847813979935647*^9, 
  3.847813997104821*^9}},ExpressionUUID->"d743d573-3a10-481d-8079-\
fa1e048efb27"],
...
installed.\>\"", ",", "session"}], "}"}], "]"}]}], "]"}], ";", 
 ...
 CellChangeTimes->{{3.82515366505571*^9, 3.825153734517518*^9}, {
   ...
   3.8478130607263412`*^9, 3.847813094614151*^9}, 
   3.847816435649303*^9},ExpressionUUID->"b6039133-1016-473e-b566-\
8b2e266ea331"],
...
Cell[BoxData[
 ...
 InitializationCell->True,
 CellChangeTimes->{{3.847814005209778*^9, 
  3.847814011129169*^9}},ExpressionUUID->"859ac4ab-81c9-4cba-bd15-\
050a52fad3ef"]
},
WindowSize->{1437.75, 801.},
WindowMargins->{{Automatic, 872.25}, {83.25, Automatic}},
TaggingRules->Association["TryRealOnly" -> False],
FrontEndVersion->"12.3 for Linux x86 (64-bit) (July 9, 2021)",
StyleDefinitions->"Default.nb",
ExpressionUUID->"809819a7-076a-4da7-81f7-1467e259c4ce"
]
...
(*NotebookFileOutline
Notebook[{
Cell[400, 13, 234, 5, 45, "Input",ExpressionUUID->"d743d573-3a10-481d-8079-fa1e048efb27",
 InitializationCell->True],
Cell[637, 20, 796, 18, 108, "Input",ExpressionUUID->"0d1c205d-9948-4aa4-a8e4-3bd5ead1ac02",
 InitializationCell->True],
Cell[1436, 40, 154218, 3219, 14133, "Input",ExpressionUUID->"b6039133-1016-473e-b566-8b2e266ea331",
 InitializationCell->True],
Cell[155657, 3261, 229, 6, 45, "Input",ExpressionUUID->"859ac4ab-81c9-4cba-bd15-050a52fad3ef",
 InitializationCell->True]
}
]
*)
